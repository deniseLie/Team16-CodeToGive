...
export const AmountTypeStep = ({ step, amount, setAmount }) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="mt-5">
                <div className="flex">
                    <p className="text-lg text-gray-700">Tax-deductable Calculator</p>
                    <Popover className="relative">
                        <PopoverButton className="text-green-700 focus:outline-none">
                            <QuestionMarkCircleIcon className="w-6 h-6 cursor-pointer" />
                        </PopoverButton>

                        <PopoverPanel className="absolute z-10 mt-2 w-64 p-3 bg-white border rounded-lg shadow-lg text-sm text-gray-700">
                            <p>
